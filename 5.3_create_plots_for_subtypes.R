...
results_IEU <- read.table("results_IEU.txt", header = T)
results_subtype <- read.table("results_subtypes.txt", header = T)
...
save_func20('subtype_consortia.png', p_grim)
...
save_func2000('subtype_grim_prc_crc.png', p_grim2)
...
save_func21('subtype_grim_pheno.png', p_grim_pheno)
save_func21('subtype_hannum_ieaa.png', p_hannum_ieaa)
